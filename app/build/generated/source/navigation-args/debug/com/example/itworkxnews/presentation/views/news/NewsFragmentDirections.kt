...
public class NewsFragmentDirections private constructor() {
  private data class ActionNewsFragmentToNewDetailFragment(
    public val article: Article
  ) : NavDirections {
    public override val actionId: Int = R.id.action_newsFragment_to_newDetailFragment
  ...
  public companion object {
    public fun actionNewsFragmentToNewDetailFragment(article: Article): NavDirections =
        ActionNewsFragmentToNewDetailFragment(article)
  }
}
