 ...
 */
public abstract class Hilt_BookmarksFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookmarksFragment_GeneratedInjector) this.generatedComponent()).injectBookmarksFragment(UnsafeCasts.<BookmarksFragment>unsafeCast(this));
    }
  }
