 ...
 */
public abstract class Hilt_NewDetailFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewDetailFragment_GeneratedInjector) this.generatedComponent()).injectNewDetailFragment(UnsafeCasts.<NewDetailFragment>unsafeCast(this));
    }
  }
