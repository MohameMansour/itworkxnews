...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatTextView textTv) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.text_tv;
      AppCompatTextView textTv = ViewBindings.findChildViewById(rootView, id);
      if (textTv == null) {
        break missingId;
      }

      return new ActivitySplashBinding((ConstraintLayout) rootView, textTv);
    }
